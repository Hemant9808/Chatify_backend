...
exports.resetPassword = exports.forgotPassword = exports.login = exports.userRegister = void 0;
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const foundUser = yield clientModel_1.default.find({ email });
        if (foundUser) {
...
const forgotPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        console.log((_a = req.body.user) === null || _a === void 0 ? void 0 : _a._id);
        console.log("enterd");
        ...
        const mailOptions = {
            ...
            html: contstants_1.welcomeEmail
        };
        //   http://${req.headers.host}/reset/${resetToken}\n\n
